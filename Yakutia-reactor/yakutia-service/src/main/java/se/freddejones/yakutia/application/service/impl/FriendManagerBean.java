...
import se.freddejones.yakutia.entity.statuses.FriendStatus;
...
public class FriendManagerBean implements FriendManagerInterface {
    ...
    public Set<Player> getFriends(Player player) {
        ...
        em.refresh(p);
        Iterator<PlayerFriend> playerFriendIter = p.getFriends().iterator();
    ...
    public Set<Player> getAllNonFriendPlayers(Player player) {
        ...
        return new HashSet<Player>(playersListCopy);
    }
