...
public class GamesPageTest extends OauthMockHarness {
    ...
    private GameEngineInterface gameEngineInterfaceMock;
    ...
    public void setUp() throws NoPlayerFoundException {
        ...
        gameEngineInterfaceMock = mock(GameEngineInterface.class);
        ...
        tester = new WicketTester(new MyMockApplication(
                new Object[]{preGameBeanMock, playerActionsInterfaceMock, gameEngineInterfaceMock}));
    }
    ...
    @Test
    public void clickButtonForCreatedGame() throws NoPlayerFoundException, NotEnoughPlayers {
        ...
        when(gameMock.getGameStatus()).thenReturn(GameStatus.ONGOING);
        when(playerMock.getGames()).thenReturn(gamePlayersSetMock);
        doNothing().when(gameEngineInterfaceMock).startNewGame(anyLong());
